      ...
      <a-menu-item @click="toggleCollapsed" key="note-important">
        ...
        <a-sub-menu key="blog">
            ...
            <a-menu-item @click="toggleCollapsed" key="blog2">
                <router-link to="/app/client-destinations">
                    {{ t("Client Destinations") }}
                </router-link>
            </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="blog3">
                <router-link to="/app/invoice-sales-order">
                    {{ t("Invoice/Sales") }} {{ t("Orders") }}
                </router-link>
            </a-menu-item>
        ...
        <a-sub-menu key="ecommerce">
            ...
            <a-menu-item @click="toggleCollapsed" key="fuel-purchase">
                <router-link to="/app/fuel-purchase-order">
                    {{ t("Fuel") }} {{ t("Purchase") }}
                </router-link>
            </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="add-product">
                <router-link to="/app/fuel-dispensation-order">

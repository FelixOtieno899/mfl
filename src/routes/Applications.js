export default [
...

    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "product" */ "../view/apps/finance/purchase-order/FuelPurchaseOrder.vue"
            ),
    },

    {
        path: "/app/fuel-purchase-order/:id",
        name: "FuelPurchaseOrderView",
        component: () =>
            import(
                /* webpackChunkName: "product" */ "../view/apps/finance/purchase-order/overview/FuelPurchaseOrderView.vue"
            ),
        props: true,
    },
    {
        path: "/app/fuel-purchase-order/edit/:id",
        name: "FuelPurchaseOrderEdit",
        component: () =>
            import(
                /* webpackChunkName: "product" */ "../view/apps/finance/purchase-order/overview/FuelPurchaseOrderEdit.vue"
            ),
        props: true,
    },

    {
        ...
        path: "/app/fuel-dispensation-order",
        component: () =>
            import(
...

    {
        ...
        path: "/app/fuel-dispensation-order/:id",
        component: () =>
            import(
...

    {
        ...
        path: "/app/fuel-dispensation-order/edit/:id",
        component: () =>
            import(
...

    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "Orders" */ "../view/apps/finance/job-card/JobCard.vue"
            ),
    },
...

    {
        ...
        path: "/app/client-destinations/:id",
        component: () =>
            import(
...

    {
        ...
        path: "/app/client-destinations/edit/:id",
        component: () =>
            import(
    ...
    {
        name: "InvoiceView",
        path: "/app/invoice-sales-order/:id",
        component: () =>
            import(
    ...
    {
        name: "InvoiceEdit",
        path: "/app/invoice-sales-order/edit/:id",
        component: () =>
            import(

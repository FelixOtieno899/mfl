                ...
                <a-row :gutter="16">
                    <a-col :span="8">
                        <a-form-Item label="Date of Birth">
                            <a-input v-model:value="formState.date_of_birth" />
                        </a-form-Item>
                    </a-col>
                    <a-col :span="8">
                    ...
                    <a-col :span="8">
                        <a-form-Item label="NSSF">
                            <a-input v-model:value="formState.nssf_number" />
                        </a-form-Item>
                    </a-col>
                </a-row>
                ...
                <a-row :gutter="16">
                    <a-col :span="8">
                        <a-form-Item label="NHIF">
                            <a-input v-model:value="formState.nhif_number" />
                        </a-form-Item>
                    </a-col>
                    <a-col :span="8">
                        <a-form-Item label="KRA Pin">
                            <a-input v-model:value="formState.kra_pin" />
                        </a-form-Item>
                    </a-col>
                    <a-col :span="8">
                        <a-form-Item label="Driver License Number">
                            <a-input v-model:value="formState.license_no" />
                        </a-form-Item>
                    </a-col>
                </a-row>

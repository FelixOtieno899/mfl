<template>
    <Main>
        <a-row :gutter="15">
            <a-col :xs="24">
                <BorderLessHeading>
                    <sdCards title="Manage Clients Destinations">
                        <a-row>
                            <a-col
                            ...
                            >
                                ...
                                <a-drawer
                                    title="Create New Client Destination"
                                    :width="720"
...
export default defineComponent({
    ...
    setup() {
                                ...
                                response.data.Client_destinations.map(
                                    (clientDestination) => ({
                                        ...
                                        contact_person: (
                                            <span class="ninjadash-username">
                                                {
                                                    clientDestination.contact_person
                                                }
                                            </span>
                                        ),
                                        contact_number: (
                                            <span class="ninjadash-username">
                                                {
                                                    clientDestination.contact_number
                                                }
                                            </span>
                                        ),
                                        contact_email: (
                                            <span>
                                                {
                                                    clientDestination.contact_email
                                                }
                                            </span>
                                        ),
                                    }),
        ...
        const viewClientDestination = (clientDestinationId) => {
            router.push(`/app/client-destinations/${clientDestinationId}`);
        };

        const editClientDestination = (clientDestinationId) => {
            router.push(`/app/client-destinations/edit/${clientDestinationId}`);
        };
        ...
        const handleSubmit = async () => {
            ...
            if (!form.client_id || !form.contact_person) {
            ...
            try {
                ...
                if (response.status === 201) {
                    ...
                    router.push({ path: "/app/client-destinations" });
                } else {
